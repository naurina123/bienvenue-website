  ...
  return (
    <div className="bg-[#192227] text-white ">
      <div className="lg:container mx-auto flex flex-col lg:flex-row gap-[3rem] p-[3rem]">
        <div className=" flex-1">
          ...
          <div className="flex gap-[1rem] ">
            ...
            <a
              href="https://www.facebook.com/ORIO-103986585601560/"
              target="_blank"
            >
              <img src="images/facebook.svg" className=" w-[2rem]" />
            </a>
            <a
              href="https://www.linkedin.com/company/orio.tech/"
              target="_blank"
            >
        ...
        <div className="flex flex-1 flex-col justify-center gap-[1rem]">
          ...
          <p>
            <a href="mailto:bienvenueco.com">bienvenueco.com</a>
          </p>
          <p>
            <a href="tel:+14164525630">+1 (416) 452 - 5630</a>
          </p>
          <p>
        ...
        <div className="flex flex-1 flex-col justify-center gap-[1rem]">
          ...
          <div className="flex justify-start items-center">
            <input
              ...
              className="rounded-l-md p-[1rem]  bg-[#323C41] h-[4rem] w-[10rem] lg:w-[15rem] "
            />
            <button className="bg-black rounded-r-md w-[100px] h-[4rem] text-[1rem]  hover:shadow-md hover:bg-[#fcc53d] hover:transition hover:ease-in">
              Submit
            </button>
          </div>
        </div>
      ...
      <div className="border-t text-center p-[2rem]">
        <p>
          Copyright 2022.<a href="https://uat.bienvenueco.com/">Bienvenue.</a>{" "}
          All Rights Reserved
        </p>
      </div>
    </div>
